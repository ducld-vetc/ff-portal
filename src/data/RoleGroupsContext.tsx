...
const defaultGroups: RoleGroup[] = [
  ...
  },
  {
    ...
    permissionKeys: [
      ...
      'operations.outbound.quick_pick',
      'operations.picking.view',
      'operations.picking.create',
      'operations.picking.assign',
      'operations.picking.b2b',
      'operations.packing.view',
      'operations.packing.label',
      'operations.inventory.adjust.view',
      'operations.shipping.handover',
      'operations.shipping.outbound_update',
      'operations.utils.issues',
      'operations.utils.print_labels',
      'operations.utils.container_devices',
      'operations.stocktake.view',
      'catalog.view',
      'carriers.units.view',
      'reports.view',
    ],
